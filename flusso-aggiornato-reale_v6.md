...
0. Lettura del dataset selezionato:

   ```
   GET /projects/{project-code}/context?key=current_dataset
   ```

   questa è una specifica GET sul context per reperire la versione corrente del dataset
...
- `GET /projects/{project-code}/questionnaire/1`
  ...
  - risposta:
    ...
    ```json
    {
      ...
      "description": "Choose a dataset from the list or upload your own.", // descrizione della pagina
      "answers": [
...
- dopodiché appare un popup o un'altra schermata per selezionare gli iperparametri:
  ...
  ```json
  {
    ...
    "random_state": {
      ...
      "type": "categorical", // input single select
      "default": 42,
      "values": [0, 1, 42, 999]
    },
    "example": {
      "label": "Example",
      "description": "Example of the selected algorithm",
      "type": "list",
      "default": ["value1", "value2"], // input multiple select
